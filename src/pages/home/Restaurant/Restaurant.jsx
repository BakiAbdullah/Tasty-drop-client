        ...
        <div className="pt-20 lg:flex lg:justify-between gap-2 ">
          <div className="lg:w-[100%] mt-5">
            ...
            <div className="ml-8 lg:flex lg:gap-4 mb-6 ">
              <div className="bg-slate-200 p-4 rounded-md mb-3 lg:mb-0 space-y-2">
                ...
                <p>Free delivery on orders of Tk 49 or more</p>
              </div>
              <div className="bg-red-100 p-4 rounded-md space-y-2">
                <p className="font-semibold ">
                  <span className="bg-yellow p-1 text-white">Gold</span> 20% off
                </p>
                <p>Free delivery on orders of Tk 99 or more.</p>
              </div>
            </div>
          </div>
        </div>
