          ...
          <div className="lg:flex lg:items-start lg:gap-8">
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-4">
              <div className="col-span-2 bg-fuchsia-300">
                ...
                <div>
                  <p className="mt-1 font-semibold text-pink">
                    From Chefs Kitchen to Your Couch, Fast & Fresh Flavors
                    Await!
                  </p>
                </div>
              </div>
