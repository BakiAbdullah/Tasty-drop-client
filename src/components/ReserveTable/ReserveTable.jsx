...
const ReserveTable = () => {
    ...
    return (
        <div className='font-Fredoka bg-[#ED284A] my-32 mx-3 md:mx-16 p-8  md:p-12 rounded-xl flex md:flex-row flex-col gap-7'>
            <div>
                <p className="text-xl md:text-5xl font-bold text-white border-b-4 border-[#FFD40D]  w-[260px] tracking-widest">RESERVE A TABLE</p>
            ...
            <form>
                <div className="flex gap-5 md:flex-row flex-col" >
                    ...
                    <div className="relative mb-6" data-te-input-wrapper-init>
                        <input className="h-12 w-full outline-none rounded-md pt-7 md:w-52 px-6 py-3 font-bold" type="date" name="" id="" />
                        <label
                            className="pointer-events-none absolute left-6  text-xs font-bold -top-2 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-950 transition-all duration-200 ease-out peer-focus:-translate-y-[.60rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-950 dark:peer-focus:text-black"
                        >Date
                        </label>
                    </div>
                    <div className="relative mb-6" data-te-input-wrapper-init>
                        <input className="h-12 pt-7 w-full outline-none rounded-md md:w-52 px-6 py-3 font-bold" type="time" name="" id="" />
                        <label
                            className="pointer-events-none absolute left-6 text-xs font-bold -top-2 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-950 transition-all duration-200 ease-out peer-focus:-translate-y-[.60rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-950 dark:peer-focus:text-black"
                        >Time
                        </label>
