...
const DashboardCards = ({ icon, title, value, percentage }) => {
  return (
    <div className="flex gap-5 items-center justify-left bg-white border-s-4 border-s-ocean hover:translate-y-1 duration-300 shadow-sm rounded-md w-full px-5 py-3">
